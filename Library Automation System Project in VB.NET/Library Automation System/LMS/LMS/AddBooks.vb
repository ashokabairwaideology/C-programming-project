Public Class AddBooks
    ...
    Sub readData()
        ...
        Try
            ...
            dr.Close()
            objcon.Close()
            If NoBook = 1 Or NoBook = 0 Then
                Label11.Text = "There is " & NoBook & " Book in the Library."
            Else

                Label11.Text = "There are " & NoBook & " Books in the Library."
            End If
