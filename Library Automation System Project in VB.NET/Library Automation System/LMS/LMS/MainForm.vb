Public Class MainForm
    ...
    Private Sub MainForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Me.Text = My.Settings.CompanyName & " Management System"
        ...
        Finally
            If My.Settings.LicenseKey = "" Then
                My.Settings.NoUse = My.Settings.NoUse - 1
                My.Settings.Save()
                Me.Text = Me.Text & " : You can still use " & My.Settings.NoUse & " times."
            End If
            If My.Settings.NoUse < 0 Then
                MsgBox("Trial usages finished!", MsgBoxStyle.Exclamation, "")
                Me.Close()
            End If
        End Try
    End Sub
