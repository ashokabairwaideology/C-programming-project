<%@ Page Language="C#" MasterPageFile="~/Admin/SimpleAdminMaster.master" AutoEventWireup="true" CodeFile="frmAdminLogin.aspx.cs" Inherits="Admin_frmAdminLogin" %>
...
<td></td>
    ...
    <tr>
        ...
        <td align="left" style="height: 26px"><asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" CssClass="btnstyle" />
            <asp:Button ID="Button1" runat="server" Text="Back" CssClass="btnstyle" OnClick="Button1_Click" CausesValidation="False"  /></td>
    </tr>
