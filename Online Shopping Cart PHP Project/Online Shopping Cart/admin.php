...
?>
	  <table width="80%" class="datatable">
	   ...
	   <tr><td>
          ...
          <table class="borderless" width="100%">
              ...
              <tr>   
                 <td><div style="text-align:center;"><a class="plain" href="?page=adminedit&filename=banned.txt&root=1"><img src="<?php echo $gfx_dir; ?>/banned.gif" alt="" /><br /><?php echo $txt['admin19']; ?></a><br /><br /></div></td>
      ...
      <?php
          // the live news feed
          if ($live_news == 1) {
              $livenews = new HTTPRequest('http://www.chaozz.nl/freewebshop.org/index.php?action=live_news');
