           ...
           // send notification to customer??
               ...
               if ($notify == "yes") {
                   ...
                   $sql = mysql_query($query) or die(mysql_error());
                    ...
                    $body = $txt['orderadmin1'] . $webid. $txt['orderadmin1'].$txt['orderadmin4'].$custid. $txt['orderadmin5'];
				    $email_header = EmailHeader($sales_mail, $charset);
		            mymail($to, $subject, $body, $email_header, $smtp_server, $smtp_port, $smtp_user, $smtp_pass, $charset);
