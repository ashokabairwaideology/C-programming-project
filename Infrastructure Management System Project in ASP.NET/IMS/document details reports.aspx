<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="Default2, App_Web_9kv_mbjt" title="Untitled Page" %>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder4" Runat="Server">
    <asp:Label ID="Doc_label" runat="server" Font-Bold="True" Style="left: 183px; position: absolute;
        top: 260px" Text="Document Label" ForeColor="White"></asp:Label>
    <asp:TextBox ID="document_label" runat="server" Style="left: 326px; position: absolute;
        top: 257px"></asp:TextBox>
         <asp:Panel ID="Panel1" runat="server" BackColor="#6699FF" Height="492px" Style="position: relative;
    ...
    <asp:Label ID="Label2" runat="server" Font-Bold="True" ForeColor="Red" Style="left: 173px;
        position: absolute; top: 298px" Text="Label" Visible="False" Width="822px"></asp:Label>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">

    <asp:GridView ID="document_details" runat="server" OnSelectedIndexChanged="document_details_SelectedIndexChanged"
        Style="left: 176px; position: absolute; top: 338px" BackColor="Gainsboro" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="Smaller" ForeColor="Black">
        <RowStyle Width="10px" />
    </asp:GridView>
    <asp:Button ID="query" runat="server" BackColor="#FFFF80" Font-Bold="True" ForeColor="#000000"
        OnClick="query_Click" Style="left: 513px; position: absolute; top: 256px" Text="Query" />
</asp:Content>
