...
Public Class rptlistofactivities
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptlistofactivities.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptlistofactivities
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptlistofactivities = New rptlistofactivities
        rpt.Site = Me.Site
        Return rpt
    End Function
