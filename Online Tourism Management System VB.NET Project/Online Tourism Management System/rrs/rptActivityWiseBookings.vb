...
Public Class rptActivityWiseBookings
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptActivityWiseBookings.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptActivityWiseBookings
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptActivityWiseBookings = New rptActivityWiseBookings
        rpt.Site = Me.Site
        Return rpt
    End Function
