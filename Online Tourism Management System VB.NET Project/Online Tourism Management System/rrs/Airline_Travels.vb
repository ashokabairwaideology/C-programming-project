...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.dbg.Location = New System.Drawing.Point(16, 16)
        Me.dbg.Name = "dbg"
        ...
        Me.txtagentcode.Location = New System.Drawing.Point(104, 32)
        Me.txtagentcode.MaxLength = 6
        Me.txtagentcode.Name = "txtagentcode"
        Me.txtagentcode.Size = New System.Drawing.Size(136, 18)
        ...
        Me.txtfaxno.Location = New System.Drawing.Point(104, 152)
        Me.txtfaxno.MaxLength = 11
        Me.txtfaxno.Name = "txtfaxno"
        Me.txtfaxno.Size = New System.Drawing.Size(136, 18)
        ...
        Me.txtremarks.Location = New System.Drawing.Point(104, 176)
        Me.txtremarks.MaxLength = 50
        Me.txtremarks.Multiline = True
        Me.txtremarks.Name = "txtremarks"
        Me.txtremarks.ScrollBars = System.Windows.Forms.ScrollBars.Vertical
        Me.txtremarks.Size = New System.Drawing.Size(136, 64)
        ...
        Me.txtmobile.Location = New System.Drawing.Point(104, 128)
        Me.txtmobile.MaxLength = 11
        Me.txtmobile.Name = "txtmobile"
        Me.txtmobile.Size = New System.Drawing.Size(136, 18)
        ...
        Me.cobcountry.Location = New System.Drawing.Point(104, 80)
        Me.cobcountry.Name = "cobcountry"
        Me.cobcountry.Size = New System.Drawing.Size(136, 20)
        ...
        Me.cobcity.Location = New System.Drawing.Point(104, 104)
        Me.cobcity.Name = "cobcity"
        Me.cobcity.Size = New System.Drawing.Size(136, 20)
        ...
        Me.txtaddress.Size = New System.Drawing.Size(136, 18)
        ...
        Me.Label29.Text = "Air Travels Id *"
        ...
        Me.Label30.Size = New System.Drawing.Size(24, 17)
        ...
        Me.Name = "Airline_Travels"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Airline Travels Master"
...
#End Region
    ...
    Private Sub Airline_Travels_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub saveproc()
        ...
        If txtagentcode.Text = "" Then
            MsgBox(" AIR TRAVELS ID MUST NOT BE EMPTY", MsgBoxStyle.OKOnly, Prjtitle)
            Exit Sub
            txtagentcode.Focus()
        End If
        If txtfirstname.Text = "" Then
            MsgBox(" NAME SHOULD NOT BE EMPTY", MsgBoxStyle.OKOnly, Prjtitle)
            Exit Sub
            txtfirstname.Focus()
        End If
        If txtaddress.Text = "" Then
            MsgBox("ADDRESS SHOULD NOT BE EMPTY", MsgBoxStyle.OKOnly, Prjtitle)
            Exit Sub
            txtaddress.Focus()
        End If
        If cobcountry.Text = "" Then
            MsgBox(" COUNTRY SHOULD NOT BE EMPTY", MsgBoxStyle.OKOnly, Prjtitle)
            Exit Sub
            cobcountry.Focus()
        End If
        If cobstate.Text = "" Then
            MsgBox("STATE SHOULD NOT BE EMPTY", MsgBoxStyle.OKOnly, Prjtitle)
            Exit Sub
            cobstate.Focus()
        End If
        If cobcity.Text = "" Then
            MsgBox("CITY SHOULD NOT BE EMPTY", MsgBoxStyle.OKOnly, Prjtitle)
            Exit Sub
            cobcity.Focus()
        End If
        ...
        cmd = New OleDb.OleDbCommand("select count(*) from Airline_Travels  where Air_TravelsId ='" & txtagentcode.Text & "'", con)
        count = cmd.ExecuteScalar
        cmd.Dispose()
        If count >= 1 Then
            con.Close()
            MsgBox(" Record already exists with this Airline TravelsId ")
            Exit Sub
        End If
        Try
            ...
            If recmode = Module1.EnuRecstatus.Recnew Then
                cmd = New OleDb.OleDbCommand("insert into Airline_Travels values('" & txtagentcode.Text & "','" & txtfirstname.Text & "','" & txtaddress.Text & "','" & txtaddress1.Text & "','" & str_ci & "','" & str_st & "','" & str_co & "'," & Val(txtzip.Text) & "," & Val(txtworkphone.Text) & "," & Val(txtmobile.Text) & "," & Val(txtfaxno.Text) & ",'" & txtemailid.Text & "','" & txtremarks.Text & "')", con)
                cmd.ExecuteNonQuery()
                cmd.Dispose()
                con.Close()
                MsgSav()
            ...
            If recmode = Module1.EnuRecstatus.Recedit Then
                'updating record
                cmd = New OleDb.OleDbCommand("update Airline_Travels set Name='" & txtfirstname.Text & "',Address='" & txtaddress.Text & "',Address1='" & txtaddress1.Text & "',CityId='" & str_ci & "',StateId='" & str_st & "',CountryId='" & str_co & "',ZIP=" & Val(txtzip.Text) & ",WorkPhone=" & Val(txtworkphone.Text) & ",Mobile=" & Val(txtmobile.Text) & ",Fax=" & Val(txtfaxno.Text) & ",Email='" & txtemailid.Text & "',Remarks='" & txtremarks.Text & "' where Air_Travelsid='" & txtagentcode.Text & "'", con)
                cmd.ExecuteNonQuery()
                cmd.Dispose()
                CloseConnection()
    ...
    Public Sub clearproc()
        'procedure for clearing the text and combo boxs
        Dim x As Object
    ...
    Public Sub delproc()
        ...
        Else
            Openconnection()
            cmd = New OleDb.OleDbCommand("delete from Airline_Travels where Air_Travelsid='" & txtagentcode.Text & "'", con)
            cmd.ExecuteNonQuery()
            MsgDel()
            clearproc()
            cmd.Dispose()
    ...
    Private Sub dbg_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dbg.DoubleClick
        ' when double clicked on the datagrid the clicked row values are displayed on tab text boxs 
        Dim str_ci As String
        Dim str_st As String
        Dim str_co As String
        ...
        Openconnection()
        cmd = New OleDb.OleDbCommand("select * from Airline_Travels where Air_Travelsid='" & dbg.Item(dbg.CurrentRowIndex, 0) & "'", con)
        ord = cmd.ExecuteReader
        While ord.Read
        ...
        cmd.Dispose()
        CloseConnection()
        disproc() ' for disable the controls
        Tabcontrol1.SelectedTab = TabPage2
    ...
    Private Sub Tabcontrol1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Tabcontrol1.Click, Tabcontrol1.TabIndexChanged
        ...
        If Tabcontrol1.SelectedTab Is TabPage1 Then
            dad = New OleDb.OleDbDataAdapter("select * from Airline_Travels", con)
            dad.Fill(ds, "trm")
            dbg.DataSource = ds
            dbg.DataMember = "trm"
        End If
    ...
    Private Sub txtagentcode_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtagentcode.Leave
        ' cheaking for already existence of air travelsid
        Dim i As Integer
        Openconnection()
        cmd = New OleDb.OleDbCommand("select count(*) from Airline_Travels where Air_Travelsid='" & txtagentcode.Text & "'", con)
        i = cmd.ExecuteScalar
    ...
    ' selects state name after selecting country name only
    ...
    ' selects city name after selecting state name only
