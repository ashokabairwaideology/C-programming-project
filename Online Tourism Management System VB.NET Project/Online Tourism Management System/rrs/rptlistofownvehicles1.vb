...
Public Class rptlistofownvehicles1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptlistofownvehicles1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptlistofownvehicles1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptlistofownvehicles1 = New rptlistofownvehicles1
        rpt.Site = Me.Site
        Return rpt
    End Function
