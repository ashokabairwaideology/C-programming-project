...
Public Class rptlistofhotelscitywise
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptlistofhotelscitywise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptlistofhotelscitywise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptlistofhotelscitywise = New rptlistofhotelscitywise
        rpt.Site = Me.Site
        Return rpt
    End Function
