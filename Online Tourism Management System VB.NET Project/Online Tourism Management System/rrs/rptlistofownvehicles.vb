...
Public Class rptlistofownvehicles
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptlistofownvehicles.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptlistofownvehicles
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptlistofownvehicles = New rptlistofownvehicles
        rpt.Site = Me.Site
        Return rpt
    End Function
