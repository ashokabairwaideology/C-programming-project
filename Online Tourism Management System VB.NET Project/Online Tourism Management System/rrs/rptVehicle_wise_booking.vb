...
Public Class rptVehicle_wise_booking
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptVehicle_wise_booking.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVehicle_wise_booking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVehicle_wise_booking = New rptVehicle_wise_booking
        rpt.Site = Me.Site
        Return rpt
    End Function
