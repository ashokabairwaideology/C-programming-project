...
Public Class rptlistofcities_state
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptlistofcities_state.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptlistofcities_state
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptlistofcities_state = New rptlistofcities_state
        rpt.Site = Me.Site
        Return rpt
    End Function
