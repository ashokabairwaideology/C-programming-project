...
Friend Class MasBrForm
		...
		Select Case Index
			...
			Case 2
				If MsgBoxResult.Yes = MsgBox("Do you want to Modify this Record", MsgBoxStyle.YesNo) Then
					Conn.Execute("update MasBr set cName='" & Text1.Text & "',Years='" & Text2.Text & "' where cName='" & cNameVar & "'")
					DisRec()
				End If
			Case 3
	...
	Private Sub MasBrForm_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
