...
Friend Class MasPgForm
	...
	Private Sub Button_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Button.Click
		...
		Select Case Index
			...
			Case 1
				...
				StrSql = "insert into MasPg(cName,Years) values "
			...
			Case 2
				If MsgBoxResult.Yes = MsgBox("Do you want to Modify this Record", MsgBoxStyle.YesNo) Then
					Conn.Execute("update MasPg set cName='" & Text1.Text & "',Years='" & Text2.Text & "' where cName='" & cNameVar & "'")
					DisRec()
				End If
			Case 3
				
				If MsgBoxResult.Yes = MsgBox("Do you want to delete this Record", MsgBoxStyle.YesNo) Then
					Conn.Execute("delete from  MasPg where CName='" & cNameVar & "'")
					DisRec()
				End If
	...
	Private Sub MasPgForm_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	Sub DisRec()
		...
		TempRS.Open("select cName,Years from MasPg order by cName")
		MSFInit()
	...
	Private Sub MSF_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MSF.DblClick
		...
		If TempRS.State = 1 Then TempRS.Close()
		TempRS.Open("select * from MasPg where cName='" & cNameVar & "' ", Conn)
