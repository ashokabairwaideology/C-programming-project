...
Begin VB.Form frmReportCashOUT 
   BackColor       =   &H00FEEADA&
   ...
   ClientTop       =   435
   ClientWidth     =   8430
   Icon            =   "frmReportCashOUT.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5820
   ...
   End
End
Attribute VB_Name = "frmReportCashOUT"
...
With db_CashOUT.Recordset
    ...
    Set l_results = lvw_recordsfound.ListItems.Add(X, , !Date)
...
StartStg = DT_Start.Value
 Endstg = DT_End.Value
If DataEnvironment1.rsCommand_CashOUT.State = adStateClosed Then DataEnvironment1.rsCommand_CashOUT.Open
    DataEnvironment1.rsCommand_CashOUT.Requery
    DataEnvironment1.rsCommand_CashOUT.Requery
    DataEnvironment1.Commands(5).CommandText = "select * from tblcashout WHERE (((tblcashout.Date) Between # " + StartStg + " # And # " + Endstg + " #)) "
    DataEnvironment1.Commands(5).Execute
    DataEnvironment1.rsCommand_CashOUT.Requery
    DataEnvironment1.rsCommand_CashOUT.Requery
    Load Rpt_CashOUT
    Rpt_CashOUT.Sections(5).Controls("label22").Caption = Format(Total_sales, "###,###,###.00")
    Rpt_CashOUT.Show vbModal
If DataEnvironment1.rsCommand_CashOUT.State = adStateOpen Then DataEnvironment1.rsCommand_CashOUT.Close
