<%@ Page Language="C#" MasterPageFile="~/HRManager/HRMasterPage.master" AutoEventWireup="true" CodeFile="EditEmpDetails.aspx.cs" Inherits="HRManager_EditEmpDetails" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    class="style25" __designer:mapid="183">
                            <tr>
                            ...
                            <tr>
                                <td align="right" class="style26">
                                    <asp:Label ID="Label19" runat="server" Text="Licence No"></asp:Label>
                                </td>
                                <td>
