...
Dim msgstr$
    Select Case (er_no)
    Case 54540:
        msgstr = "Error(54540):Pajisje invalide."
    Case 54541:
        msgstr = "Error(54541):Lartesia e gabuar."
    Case 54542:
        msgstr = "Error(54542):Lartesia e gabuar."
    Case 54543:
        msgstr = "Error(54543):Eshte gjetur simbol i panjohur."
    Case 54544:
       msgstr = "Error(54544):Nje gabim eshte gjetur gjat krijimit te fonteve."
    Case 54545:
        msgstr = "Error(54545):Jashte memorjes."
    Case 54546:
        msgstr = "Error(54546):Gabim radhitje e titullit"
    Case 54547:
        msgstr = "Error(54547):Gabim pozicioni i titullit."
    Case 54548:
        msgstr = "Error(54548):Karakter i gabuar per kete simbologji."
    Case Else
        msgstr = ""
    End Select
