...
Begin VB.Form frmTerheqjeNew 
   ...
   End
End
Attribute VB_Name = "frmTerheqjeNew"
...
Call dbconek
With ar
.Open "Select *From tblTerheqjet", strConek, adOpenStatic, adLockOptimistic
.AddNew
!id = txtid
...
Call dbconek
With ar
criteria = "Select *From tblTerheqjet"
.Open criteria, strConek, adOpenStatic, adLockOptimistic
If ar.RecordCount = 0 Then
txtid.Text = "1"
Else
